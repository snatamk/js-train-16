...
function warnAboutMaxArrayLength(arr, maxLength) {
  ...
  // Якщо arr не є масивом або maxLength не є числом, виведеме в консоль критичну помилоку з текстом:
  ...
  // Якщо довжина масиву перевищує максимальну, виводимо попередження про потенційну проблеми з текстом:
  // "Увага! Довжина масиву перевищує максимально допустиму!".
  // Якщо довжина масиву не перевищує максимальну, виведеме в консоль корисне повідомлення з текстом:
...
function compareArrays(arr1, arr2) {
  ...
  let a = JSON.stringify(arr1.sort());
  let b = JSON.stringify(arr2.sort());

  let c = a === b;
  console.assert(c, "Помилка: масиви не однакові");
}
...
function calculateTotalPrice(products) {
  ...
  const total = products.reduce((elem, product) => elem + product.price, 0);
